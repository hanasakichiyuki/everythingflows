  ...
  (
    ...
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "anim-fade-in fixed left-1/2 top-1/2 z-50 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border bg-background p-6 text-foreground shadow-2xl focus:outline-none",
          className
        )}
        {...props}
      >
